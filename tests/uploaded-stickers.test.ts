...
describe("uploaded stickers", () => {
  ...
  it("copies and deduplicates images, reloads without the source and exports through the existing plan", async () => {
    ...
    const automatic = { summary: "选择用户上传贴纸", captions: [], priceStyle: "classic", stickers: [{ corner: "top-left", sticker: imported.id, width: 0.12, rotationDeg: 0 }], filter: "warm", intensity: 0.4 };

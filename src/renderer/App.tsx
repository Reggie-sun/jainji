...
export default function App() {
  ...
  const start = () => void run(async () => {
    apply(await window.jianji.startAgent({ mediaIds: selected, ruleId: rule, brief, outputDirectory }));
    setStep("results");
  });

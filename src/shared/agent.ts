...
export const RULE_TEMPLATES = [
  ...
  { id: "clean", name: "清爽日常", label: "生活记录", description: "清透色彩配轻箭头贴纸，让日常画面保持自然呼吸感。", minIntensity: 0.25, maxIntensity: 0.4, filters: ["cool", "vivid"], filterLabel: "清透", sticker: "arrow", stickerLabel: "青色箭头", stickerWidth: 0.11, stickerRotation: -6, stickerCorners: ["bottom-left", "bottom-right", "top-left", "top-right"] },
  { id: "mono", name: "黑白叙事", label: "情绪片段", description: "完整黑白滤镜配小型闪光贴纸，突出人物与情绪。", minIntensity: 1, maxIntensity: 1, filters: ["mono"], filterLabel: "黑白", sticker: "sparkle", stickerLabel: "白色闪光", stickerWidth: 0.1, stickerRotation: -8, stickerCorners: ["top-right", "bottom-right", "top-left", "bottom-left"] },
  { id: "coral-pop", name: "珊瑚热卖", label: "促销种草", description: "鲜明滤镜配爱心贴纸，活泼但不遮挡商品主体。", minIntensity: 0.45, maxIntensity: 0.68, filters: ["vivid", "warm"], filterLabel: "鲜明", sticker: "heart", stickerLabel: "珊瑚爱心", stickerWidth: 0.12, stickerRotation: 7, stickerCorners: ["bottom-right", "top-right", "bottom-left", "top-left"] },
  { id: "mint-fresh", name: "薄荷上新", label: "清新开箱", description: "冷调滤镜配方向箭头，适合开箱、展示与步骤感画面。", minIntensity: 0.3, maxIntensity: 0.48, filters: ["cool"], filterLabel: "冷调", sticker: "arrow", stickerLabel: "薄荷箭头", stickerWidth: 0.12, stickerRotation: 6, stickerCorners: ["top-right", "bottom-right", "top-left", "bottom-left"] },

...
import { SaveConnectionSchema, SelectModelSchema, type SelectModel, type ConnectionLibrary } from "../shared/connections.js";
...
export class ConnectionStore {
  ...
  async selectVision(vision: SelectModel | null): Promise<void> {
